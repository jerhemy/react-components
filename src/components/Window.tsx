                                    ...
                                    <div className="noti-scroll" data-simplebar>
                                        ...
                                        <a href="javascript:void(0);" className="dropdown-item notify-item text-muted link-primary">
                                            ...
                                            <div className="notify-content">
                                                ...
                                                <p className="noti-mentioned p-2 rounded-2 mb-0 mt-2"><span className="text-primary">@Patryk</span> Please make sure that you're....</p>
                                            </div>
                                        </a>
                                        ...
                                        <a href="javascript:void(0);" className="dropdown-item notify-item text-muted link-primary">
                                            ...
                                            <div className="notify-content">
                                                ...
                                                <p className="noti-mentioned p-2 rounded-2 mb-0 mt-2"><span className="text-reset">@Patryk</span> Please make sure that you're....</p>
                                            </div>
                                        </a>
                                    </div>
                        ...
                        <a className="nav-link dropdown-toggle nav-user me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="assets/images/users/user-5.jpg" alt="user-image" className="rounded-circle">
                                <span className="pro-user-name ms-1">
                                    John Smith <i className="mdi mdi-chevron-down"></i>
                                </span>
                        </a>
            ...
            <div id="sidebar-menu">
                    ...
                    <li>
                        ...
                        <div className="collapse" id="sidebarDashboards">
                            <ul className="nav-second-level">
                                <li>
                                    <a className='tp-link' href='index.html'>CRM</a>
                                </a>                                       </li>
                            <li>
                                <a className='tp-link' href='analytics.html'>Analytics</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ecommerce.html'>eCommerce</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div className="collapse" id="sidebarAuth">
                        <ul className="nav-second-level">
                            <li>
                                <a className='tp-link' href='auth-login.html'>Log In</a>
                            </li>
                            <li>
                                <a className='tp-link' href='auth-register.html'>Register</a>
                            </li>
                            <li>
                                <a className='tp-link' href='auth-recoverpw.html'>Recover Password</a>
                            </li>
                            <li>
                                <a className='tp-link' href='auth-lock-screen.html'>Lock Screen</a>
                            </li>
                            <li>
                                <a className='tp-link' href='auth-confirm-mail.html'>Confirm Mail</a>
                            </li>
                            <li>
                                <a className='tp-link' href='email-verification.html'>Email Verification</a>
                            </li>
                            <li>
                                <a className='tp-link' href='auth-logout.html'>Logout</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div className="collapse" id="sidebarError">
                        <ul className="nav-second-level">
                            <li>
                                <a className='tp-link' href='error-404.html'>Error 404</a>
                            </li>
                            <li>
                                <a className='tp-link' href='error-500.html'>Error 500</a>
                            </li>
                            <li>
                                <a className='tp-link' href='error-503.html'>Error 503</a>
                            </li>
                            <li>
                                <a className='tp-link' href='error-429.html'>Error 429</a>
                            </li>
                            <li>
                                <a className='tp-link' href='offline-page.html'>Offline Page</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div className="collapse" id="sidebarExpages">
                        <ul className="nav-second-level">
                            <li>
                                <a className='tp-link' href='pages-starter.html'>Starter</a>
                            </li>
                            <li>
                                <a className='tp-link' href='pages-profile.html'>Profile</a>
                            </li>
                            <li>
                                <a className='tp-link' href='pages-pricing.html'>Pricing</a>
                            </li>
                            <li>
                                <a className='tp-link' href='pages-timeline.html'>Timeline</a>
                            </li>
                            <li>
                                <a className='tp-link' href='pages-invoice.html'>Invoice</a>
                            </li>
                            <li>
                                <a className='tp-link' href='pages-faqs.html'>FAQs</a>
                            </li>
                            <li>
                                <a className='tp-link' href='pages-gallery.html'>Gallery</a>
                            </li>
                            <li>
                                <a className='tp-link' href='pages-maintenance.html'>Maintenance</a>
                            </li>
                            <li>
                                <a className='tp-link' href='pages-coming-soon.html'>Coming Soon</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    <a className='tp-link' href='apps-todolist.html'>
                ...
                <li>
                    <a className='tp-link' href='apps-contacts.html'>
                ...
                <li>
                    <a className='tp-link' href='apps-calendar.html'>
                        <i data-feather="calendar"></i>
                        <span> Calendar </span>
                    </a>
                </li>

                <li className="menu-title mt-2">General</li>
                ...
                <li>
                    ...
                    <div className="collapse" id="sidebarBaseui">
                        <ul className="nav-second-level">
                            <li>
                                <a className='tp-link' href='ui-accordions.html'>Accordions</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ui-alerts.html'>Alerts</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ui-badges.html'>Badges</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ui-breadcrumb.html'>Breadcrumb</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ui-buttons.html'>Buttons</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ui-cards.html'>Cards</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ui-collapse.html'>Collapse</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ui-dropdowns.html'>Dropdowns</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ui-video.html'>Embed Video</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ui-grid.html'>Grid</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ui-images.html'>Images</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ui-list.html'>List Group</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ui-modals.html'>Modals</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ui-placeholders.html'>Placeholders</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ui-pagination.html'>Pagination</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ui-popovers.html'>Popovers</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ui-progress.html'>Progress</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ui-scrollspy.html'>Scrollspy</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ui-spinners.html'>Spinners</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ui-tabs.html'>Tabs</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ui-tooltips.html'>Tooltips</a>
                            </li>
                            <li>
                                <a className='tp-link' href='ui-typography.html'>Typography</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    <a className='tp-link' href='widgets.html'>
                ...
                <li>
                    ...
                    <div className="collapse" id="sidebarAdvancedUI">
                        <ul className="nav-second-level">
                            <li>
                                <a className='tp-link' href='extended-carousel.html'>Carousel</a>
                            </li>
                            <li>
                                <a className='tp-link' href='extended-notifications.html'>Notifications</a>
                            </li>
                            <li>
                                <a className='tp-link' href='extended-offcanvas.html'>Offcanvas</a>
                            </li>
                            <li>
                                <a className='tp-link' href='extended-range-slider.html'>Range Slider</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div className="collapse" id="sidebarIcons">
                        <ul className="nav-second-level">
                            <li>
                                <a className='tp-link' href='icons-feather.html'>Feather Icons</a>
                            </li>
                            <li>
                                <a className='tp-link' href='icons-mdi.html'>Material Design Icons</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div className="collapse" id="sidebarForms">
                        <ul className="nav-second-level">
                            <li>
                                <a className='tp-link' href='forms-elements.html'>General Elements</a>
                            </li>
                            <li>
                                <a className='tp-link' href='forms-validation.html'>Validation</a>
                            </li>
                            <li>
                                <a className='tp-link' href='forms-quilljs.html'>Quilljs Editor</a>
                            </li>
                            <li>
                                <a className='tp-link' href='forms-pickers.html'>Picker</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div className="collapse" id="sidebarTables">
                        <ul className="nav-second-level">
                            <li>
                                <a className='tp-link' href='tables-basic.html'>Basic Tables</a>
                            </li>
                            <li>
                                <a className='tp-link' href='tables-datatables.html'>Data Tables</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div className="collapse" id="sidebarCharts">
                        <ul className="nav-second-level">
                            <li>
                                <a className='tp-link' href='charts-line.html'>Line</a>
                            </li>
                            <li>
                                <a className='tp-link' href='charts-area.html'>Area</a>
                            </li>
                            <li>
                                <a className='tp-link' href='charts-column.html'>Column</a>
                            </li>
                            <li>
                                <a className='tp-link' href='charts-bar.html'>Bar</a>
                            </li>
                            <li>
                                <a className='tp-link' href='charts-mixed.html'>Mixed</a>
                            </li>
                            <li>
                                <a className='tp-link' href='charts-timeline.html'>Timeline</a>
                            </li>
                            <li>
                                <a className='tp-link' href='charts-rangearea.html'>Range Area</a>
                            </li>
                            <li>
                                <a className='tp-link' href='charts-funnel.html'>Funnel</a>
                            </li>
                            <li>
                                <a className='tp-link' href='charts-candlestick.html'>Candlestick</a>
                            </li>
                            <li>
                                <a className='tp-link' href='charts-boxplot.html'>Boxplot</a>
                            </li>
                            <li>
                                <a className='tp-link' href='charts-bubble.html'>Bubble</a>
                            </li>
                            <li>
                                <a className='tp-link' href='charts-scatter.html'>Scatter</a>
                            </li>
                            <li>
                                <a className='tp-link' href='charts-heatmap.html'>Heatmap</a>
                            </li>
                            <li>
                                <a className='tp-link' href='charts-treemap.html'>Treemap</a>
                            </li>
                            <li>
                                <a className='tp-link' href='charts-pie.html'>Pie</a>
                            </li>
                            <li>
                                <a className='tp-link' href='charts-radialbar.html'>Radialbar</a>
                            </li>
                            <li>
                                <a className='tp-link' href='charts-radar.html'>Radar</a>
                            </li>
                            <li>
                                <a className='tp-link' href='charts-polararea.html'>Polar</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div className="collapse" id="sidebarMaps">
                        <ul className="nav-second-level">
                            <li>
                                <a className='tp-link' href='maps-google.html'>Google Maps</a>
                            </li>
                            <li>
                                <a className='tp-link' href='maps-vector.html'>Vector Maps</a>
                            </li>
                        </ul>
                    </div>
                </li>
                        ...
                        <div className="card">
                            <div className="card-header">
                                <div className="d-flex align-items-center">
                                    <h5 className="card-title text-black mb-0">Sales Overview</h5>

                                    <div className="ms-auto">
                                        <button className="btn btn-sm bg-light border dropdown-toggle fw-medium text-black" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">This Month<i className="mdi mdi-chevron-down ms-1 fs-14"></i></button>
                            ...
                            <div className="card-body">
                                <div id="sales-overview" className="apex-charts"></div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div className="card-body">
                                        <div className="widget-first">
                                            ...
                                            <div className="d-flex align-items-center mb-2">
                                                <div className="p-2 border border-primary border-opacity-10 bg-primary-subtle rounded-pill me-2">
                                                    <div className="bg-primary rounded-circle widget-size text-center">
                                                ...
                                                <p className="mb-0 text-dark fs-15">Total Customers</p>
                                            </div>

                                            <div className="d-flex justify-content-between align-items-center">
                                                <h3 className="mb-0 fs-22 text-black me-3">3,456</h3>
                                                <div className="text-center">
                                                    <span className="text-primary fs-14"><i className="mdi mdi-trending-up fs-14"></i> 12.5%</span>
                                ...
                                <div className="card mb-0">
                                    <div className="card-body">
                                        <div className="widget-first">
                                            ...
                                            <div className="d-flex align-items-center mb-2">
                                                <div className="p-2 border border-secondary border-opacity-10 bg-secondary-subtle rounded-pill me-2">
                                                ...
                                                <p className="mb-0 text-dark fs-15">Active Customers</p>
                                            </div>

                                            <div className="d-flex justify-content-between align-items-center">
                                                <h3 className="mb-0 fs-22 text-black me-3">2,839</h3>
                                                <div className="text-center">
                                                    <span className="text-danger fs-14 me-2"><i className="mdi mdi-trending-down fs-14"></i> 1.5%</span>
                                                    <p className="text-dark fs-13 mb-0">Last 7 days</p>
                                                </div>
                                            </div>
                                ...
                                <div className="card mb-0">
                                    <div className="card-body">
                                        <div className="widget-first">
                                            ...
                                            <div className="d-flex align-items-center mb-2">
                                                <div className="p-2 border border-danger border-opacity-10 bg-danger-subtle rounded-pill me-2">
                                                    <div className="bg-danger rounded-circle widget-size text-center">
                                                ...
                                                <p className="mb-0 text-dark fs-15">Profit Total</p>
                                            </div>

                                            <div className="d-flex justify-content-between align-items-center">
                                                <h3 className="mb-0 fs-22 text-black me-3">$7,254</h3>
                                                <div className="text-center">
                                                    <span className="text-primary fs-14 me-2"><i className="mdi mdi-trending-up fs-14"></i> 12.8%</span>
                                                    <p className="text-dark fs-13 mb-0">Last 7 days</p>
                                                </div>
                                            </div>
                                ...
                                <div className="card mb-0">
                                    <div className="card-body">
                                        <div className="widget-first">
                                            ...
                                            <div className="d-flex align-items-center mb-2">
                                                <div className="p-2 border border-warning border-opacity-10 bg-warning-subtle rounded-pill me-2">
                                                    <div className="bg-warning rounded-circle widget-size text-center">
                                                ...
                                                <p className="mb-0 text-dark fs-15">Expense Total</p>
                                            </div>


                                            <div className="d-flex justify-content-between align-items-center">
                                                <h3 className="mb-0 fs-22 text-black me-3">$4,578</h3>

                                                <div className="text-muted">
                                                    <span className="text-danger fs-14 me-2"><i className="mdi mdi-trending-down fs-14"></i> 18%</span>
                                                    <p className="text-dark fs-13 mb-0">Last 7 days</p>
                                                </div>
                                            </div>
                                ...
                                <div className="card mb-0">
                                    <div className="card-body">
                                        <div className="widget-first">
                                            ...
                                            <div className="d-flex align-items-center mb-2">
                                                <div className="p-2 border border-success border-opacity-10 bg-success-subtle rounded-pill me-2">
                                            ...
                                            <div className="d-flex justify-content-between align-items-center">
                                                <h3 className="mb-0 fs-22 text-black me-3">14.57%</h3>

                                                <div className="text-muted">
                                                    <span className="text-primary fs-14 me-2"><i className="mdi mdi-trending-up fs-14"></i> 5.8%</span>
                                                    <p className="text-dark fs-13 mb-0">Last 7 days</p>
                                                </div>
                                            </div>
                                ...
                                <div className="card">
                                    <div className="card-body">
                                        <div className="widget-first">
                                            ...
                                            <div className="d-flex align-items-center mb-2">
                                                <div className="p-2 border border-dark border-opacity-10 bg-dark-subtle rounded-pill me-2">
                                                    <div className="bg-dark rounded-circle widget-size text-center">
                                                ...
                                                <p className="mb-0 text-dark fs-15">Total Deals</p>
                                            </div>


                                            <div className="d-flex justify-content-between align-items-center">
                                                <h3 className="mb-0 fs-22 text-black me-3">8,754</h3>

                                                <div className="text-muted">
                                                    <span className="text-primary fs-14 me-2"><i className="mdi mdi-trending-up fs-14"></i> 4.5%</span>
                                                    <p className="text-dark fs-13 mb-0">Last 7 days</p>
                                                </div>
                                            </div>
                ...
                <div className="row">
                    <div className="col-md-12 col-xl-6">
                        <div className="card">
                            <div className="card-header">
                                <div className="d-flex align-items-center">
                                    <h5 className="card-title text-black mb-0">Latest transactions</h5>
                                </div>
                            </div>
                                    ...
                                    <li className="list-group-item">
                                        <div className="d-flex">
                                            ...
                                            <div className="flex-shrink-0 align-self-center">
                                                ...
                                                <div className="align-content-center text-center border border-dashed rounded-circle p-1">
                                                    <img src="assets/images/users/user-12.jpg" className="avatar avatar-sm rounded-circle">
                                                </div>
                                            ...
                                            <div className="flex-grow-1 ms-3 align-content-center">
                                                <div className="row">
                                                    <div className="col-7 col-md-5 order-md-1">
                                                        <h6 className="mb-1 text-black fs-15">Bob Dean</h6>
                                                        <span className="fs-14 text-muted">Transfer to bank account</span>
                                                    </div>

                                                    <div className="col-5 col-md-4 order-md-3 text-end mt-2 mt-md-0">
                                                        <h6 className="mb-1 text-black fs-14">$158.00 USD</h6>
                                                        <span className="fs-13 text-muted">24 Jan, 2024</span>
                                                    </div>

                                                    <div className="col-auto col-md-3 order-md-2 align-self-center">
                                                        <span className="badge bg-warning-subtle text-warning fw-semibold rounded-pill">Pending</span>
                                                    </div>
                                                </div>
                                    ...
                                    <li className="list-group-item">
                                        <div className="d-flex">
                                            ...
                                            <div className="flex-shrink-0 align-self-center">
                                                ...
                                                <div className="avatar border border-dashed rounded-circle align-content-center text-center p-1">
                                            ...
                                            <div className="flex-grow-1 ms-3 align-content-center">
                                                <div className="row">
                                                    <div className="col-7 col-md-5 order-md-1">
                                                        <h6 className="mb-1 text-black fs-15">Bank of America</h6>
                                                        <span className="fs-14 text-muted">Withdrawal to account</span>
                                                    </div>

                                                    <div className="col-5 col-md-4 order-md-3 text-end mt-2 mt-md-0">
                                                        <h6 className="mb-1 text-success fs-14">$258.00 USD</h6>
                                                        <span className="fs-13 text-muted">26 June, 2024</span>
                                                    </div>

                                                    <div className="col-auto col-md-3 order-md-2 align-self-center">
                                                        <span className="badge bg-success-subtle text-success fw-semibold rounded-pill">Completed</span>
                                                    </div>
                                                </div>
                                    ...
                                    <li className="list-group-item">
                                        <div className="d-flex">
                                            ...
                                            <div className="flex-grow-1 ms-3 align-content-center">
                                                <div className="row">
                                                    <div className="col-7 col-md-5 order-md-1">
                                                        <h6 className="mb-1 text-black fs-15">Slack</h6>
                                                        <span className="fs-14 text-muted">Subscription to plan</span>
                                                    </div>

                                                    <div className="col-5 col-md-4 order-md-3 text-end mt-2 mt-md-0">
                                                        <h6 className="mb-1 text-black fs-14">-$154.00 USD</h6>
                                                        <span className="fs-13 text-muted">12 May, 2024</span>
                                                    </div>

                                                    <div className="col-auto col-md-3 order-md-2 align-self-center">
                                                        <span className="badge bg-danger-subtle text-danger fw-semibold rounded-pill">Failed</span>
                                                    </div>
                                                </div>
                                    ...
                                    <li className="list-group-item">
                                        <div className="d-flex">
                                            ...
                                            <div className="flex-grow-1 ms-3 align-content-center">
                                                <div className="row">
                                                    <div className="col-7 col-md-5 order-md-1">
                                                        <h6 className="mb-1 text-black fs-15">Asana</h6>
                                                        <span className="fs-14 text-muted">Subscription payment</span>
                                                    </div>

                                                    <div className="col-5 col-md-4 order-md-3 text-end mt-2 mt-md-0">
                                                        <h6 className="mb-1 text-success fs-14">$258.00 USD</h6>
                                                        <span className="fs-13 text-muted">15 Fab, 2024</span>
                                                    </div>
                                    ...
                                    <li className="list-group-item">
                                        <div className="d-flex">
                                            ...
                                            <div className="flex-grow-1 ms-3 align-content-center">
                                                <div className="row">
                                                    <div className="col-7 col-md-5 order-md-1">
                                                        <h6 className="mb-1 text-black fs-15">Github Copilot</h6>
                                                        <span className="fs-14 text-muted">Renew A Plan</span>
                                                    </div>

                                                    <div className="col-5 col-md-4 order-md-3 text-end mt-2 mt-md-0">
                                                        <h6 className="mb-1 text-black fs-14">$89.00 USD</h6>
                                                        <span className="fs-13 text-muted">25 April, 2024</span>
                                                    </div>

                                                    <div className="col-auto col-md-3 order-md-2 align-self-center">
                                                        <span className="badge bg-primary-subtle text-primary fw-semibold rounded-pill">Completed</span>
                                                    </div>
                                                </div>
                    ...
                    <div className="col-md-6 col-xl-3">
                        <div className="card overflow-hidden">
                            <div className="card-header">
                                <div className="d-flex align-items-center">
                                    <h5 className="card-title text-black mb-0">Deals Statistics</h5>
                                </div>
                            </div>

                            <div className="card-body">
                                <div id="deals-statistics" className="apex-charts"></div>
                            </div>
                    ...
                    <div className="col-md-6 col-xl-3">
                        <div className="card">
                            <div className="card-header">
                                <div className="d-flex align-items-center">
                                    <h5 className="card-title text-black mb-0">Your Recent Perfomance</h5>
                                </div>
                            </div>

                            <div className="card-body">
                                <div id="browservisiting" className="apex-charts"></div>

                                <div className="text-center fw-medium my-3">78% increase in company growth.</div>
                                ...
                                <div className="d-flex gap-3 justify-content-between">
                                    <div className="d-flex">
                                        ...
                                        <div className="d-flex flex-column">
                                            ...
                                            <h6 className="mb-0 fs-15">$32.5k</h6>
                                        </div>
                                    </div>

                                    <div className="d-flex">
                                        <div className="bg-success-subtle rounded-2 p-1 me-2 border border-dashed border-success">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                                        ...
                                        <div className="d-flex flex-column">
                                            ...
                                            <h6 className="mb-0 fs-15">$41.2k</h6>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="row">
                    <div className="col-xl-4">
                        <div className="card overflow-hidden">
                            <div className="card-header">
                                <div className="d-flex align-items-center">
                                    <h5 className="card-title text-black mb-0">Product Activity</h5>
                                </div>
                            </div>
                            ...
                            <div className="card-body">
                                <div className="row">
                                    <div className="col-xxl-6">
                                        <div id="productactivity" className="apex-charts"></div>
                                    </div>

                                    <div className="col-xxl-6 align-self-center">
                                        <h3 className="fs-18 fw-semibold text-black mb-3">Data Statistic</h3>
                                        <ul className="list-unstyled mb-0">

                                            <li className="list-item mb-2 align-self-center">
                                                <div className="d-flex align-items-center justify-content-between fs-15">
                                                    <div className="">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 16 16" className="me-0"><path fill="#2786f1" d="M4 8a4 4 0 1 1 8 0a4 4 0 0 1-8 0m4-2.5a2.5 2.5 0 1 0 0 5a2.5 2.5 0 0 0 0-5" /></svg>
                                                        <span className="text-black fw-normal">To Be Packed </span>
                                                    </div>
                                                    <p className="mb-0 text-muted">157.880</p>
                                                </div>
                                            </li>
                                            ...
                                            <li className="list-item mb-2 align-self-center">
                                                <div className="d-flex align-items-center justify-content-between fs-15">
                                                    <div className="">
                                                        ...
                                                        <span className="text-black fw-normal">Process Delivery </span>
                                                    </div>
                                                    <p className="mb-0 text-muted">198.254</p>
                                                </div>
                                            </li>

                                            <li className="list-item text-black align-self-center fs-15">
                                                <div className="d-flex align-items-center justify-content-between fs-15">
                                                    <div className="">
                                                        ...
                                                        <span className="text-black fw-normal">Delivery Done</span>
                                                    </div>
                                                    <p className="mb-0 text-muted">142.278</p>
                                                </div>
                                            </li>
                        ...
                        <div className="card overflow-hidden">
                            <div className="card-header">
                                <div className="d-flex align-items-center">
                                    <h5 className="card-title text-black mb-0">Sales by Countries</h5>
                                    <div className="ms-auto">
                                        <button className="btn btn-sm bg-light border dropdown-toggle fw-medium text-black" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">View All<i className="mdi mdi-chevron-down ms-1 fs-14"></i></button>
                                        <div className="dropdown-menu dropdown-menu-end">
                                ...
                                <ul className="p-0 m-0">
                                    <li className="d-flex mb-3">
                                        <div className="d-flex w-50 align-items-center me-4">
                                            ...
                                            <div>
                                                <h6 className="mb-0 me-1 fs-15 fw-semibold text-black">USA</h6>
                                            </div>
                                        </div>

                                        <div className="d-flex flex-grow-1 align-items-center">
                                            <div className="progress progress-md w-100 me-4 mt-2" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100">
                                    ...
                                    <li className="d-flex mb-3">
                                        <div className="d-flex w-50 align-items-center me-4">
                                            ...
                                            <div>
                                                <h6 className="mb-0 me-1 fs-15 fw-semibold text-black">Australia</h6>
                                            </div>
                                        </div>
                                    ...
                                    <li className="d-flex align-items-center mb-0">
                                        ...
                                        <div className="d-flex w-50 align-items-center me-4">
                                            ...
                                            <div>
                                                <h6 className="mb-0 me-1 fs-15 fw-semibold text-black">India</h6>
                                            </div>
                                        </div>
                    ...
                    <div className="col-xl-8">
                        <div className="card overflow-hidden">
                            ...
                            <div className="card-header">
                                <div className="d-flex align-items-center">
                                    <h5 className="card-title text-black mb-0">Leads Report</h5>
                                </div>
                            </div>
                                ...
                                <div className="table-responsive table-card mt-0">
                                    <table className="table table-borderless table-centered align-middle table-nowrap mb-0">
                                        <thead className="text-muted table-light">
                                            <tr>
                                                <th scope="col" className="cursor-pointer">Lead</th>
                                                <th scope="col" className="cursor-pointer">Email</th>
                                                <th scope="col" className="cursor-pointer">Phone No</th>
                                                <th scope="col" className="cursor-pointer">Campany</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <img src="assets/images/users/user-12.jpg" className="avatar avatar-sm rounded-circle me-3">
                                                        John Hamilton
                                                </td>
                                                ...
                                                <td>Mufti</td>
                                                <td>
                                                    <span className="badge bg-primary-subtle text-primary fw-semibold">New Lead</span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="assets/images/users/user-11.jpg" className="avatar avatar-sm rounded-circle me-3">
                                                        Janice Reese
                                                </td>
                                                ...
                                                <td>Gucci</td>
                                                <td>
                                                    <span className="badge bg-secondary-subtle text-secondary fw-semibold">In Progress</span>
                                                </td>
                                                <td>
                                                    <a aria-label="anchor" className="me-1" data-bs-toggle="tooltip" data-bs-original-title="Edit">
                                                        <i className="mdi mdi-pencil-outline fs-16 text-muted"></i>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="assets/images/users/user-13.jpg" className="avatar avatar-sm rounded-circle me-3">
                                                        Andrew Kim
                                                </td>
                                                ...
                                                <td>Vans</td>
                                                <td>
                                                    <span className="badge bg-danger-subtle text-danger fw-semibold">Loss</span>
                                                </td>
                                                <td>
                                                    <a aria-label="anchor" className="me-1" data-bs-toggle="tooltip" data-bs-original-title="Edit">
                                                        <i className="mdi mdi-pencil-outline fs-16 text-muted"></i>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="assets/images/users/user-14.jpg" className="avatar avatar-sm rounded-circle me-3">
                                                        Kathryn Sanchez
                                                </td>
                                                ...
                                                <td>Myntra</td>
                                                <td>
                                                    <span className="badge bg-success-subtle text-success fw-semibold">Won</span>
                                                </td>
                                                <td>
                                                    <a aria-label="anchor" className="me-1" data-bs-toggle="tooltip" data-bs-original-title="Edit">
                                                        <i className="mdi mdi-pencil-outline fs-16 text-muted"></i>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="assets/images/users/user-15.jpg" className="avatar avatar-sm rounded-circle me-3">
                                                        Diane Richards
                                                </td>
                                                ...
                                                <td>HCLTech</td>
                                                <td>
                                                    <span className="badge bg-warning-subtle text-warning fw-semibold">Converted</span>
                                                </td>
                                                <td>
                                                    <a aria-label="anchor" className="me-1" data-bs-toggle="tooltip" data-bs-original-title="Edit">
                                                        <i className="mdi mdi-pencil-outline fs-16 text-muted"></i>
            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="col fs-13 text-muted text-center">
                        &copy; <script>document.write(new Date().getFullYear())</script> - Made with <span className="mdi mdi-heart text-danger"></span> by <a href="#!" className="text-reset fw-semibold">Zoyothemes</a>
                    </div>
                </div>
            </div>
        </footer>
